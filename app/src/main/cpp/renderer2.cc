...
public:
    ...
    void render2(const Matrix44F& projectionMatrix, const Matrix44F& cameraview, Vec2F size);
private:
...
void Renderer2::init()
{
    ...
    mScene=mImporter.ReadFile("",pFlag);
...
void Renderer2::render(const Matrix44F& projectionMatrix, const Matrix44F& cameraview, Vec2F size)
{
    glBindBuffer(GL_ARRAY_BUFFER, vbo_coord_box);
